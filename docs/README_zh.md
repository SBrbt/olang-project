...
| 阶段 | 文档 | 说明 |
|------|------|------|
| 5分钟 | [learn/quickstart_zh.md](learn/quickstart_zh.md) | 安装、构建、运行第一个程序 |
| 1小时 | [learn/tutorial_zh.md](learn/tutorial_zh.md) | 完整语言教程 |
| 实践 | [learn/examples_zh.md](learn/examples_zh.md) | 30+ 个可运行示例 |

### 我想查阅参考

| 主题 | 文档 |
|------|------|
| 语法 | [book/syntax_zh.md](book/syntax_zh.md) |
| 类型系统 | [book/types_zh.md](book/types_zh.md) |
| 运算符 | [book/operators_zh.md](book/operators_zh.md) |
